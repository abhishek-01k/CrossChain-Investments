...
export default function MyBots() {
  ...
  useEffect(() => {
    if (isLoggedIn && id) {
      const welcomeMessage = "Welcome to the CrossChain-Investments Bot!"
      ...
      <div className="w-full border-l-2 px-4">
        <div className="flex flex-row gap-4 py-4">
          ...
          <div className="">
            {!isLoggedIn ? (
              <TelegramLoginButton
                botName="crosschain_investment_bot"
                dataOnauth={(user) => console.log(user)}
                // dataAuthUrl="https://crosschain-investments.vercel.app/myaibot"
                cornerRadius={5}
              />
            ) : (
